...
%   any combination of the last four arguments.  BACKPROJ uses 
...
%% 11.3.2011 JUSSI FORMA: Corrected a minor error which caused artefact, see line 134-142.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%JUSSI FORMA 11.3.2011: old way of making y axis causes misalignment-like
%artefact, probably because of interpolation in imrot90.
% y = rot90(x);
center = floor((N + 1)/2);
ytop = center - 1;
y = (N:-1:1).' - N + ytop;
